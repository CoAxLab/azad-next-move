...
wythoff_exp25:
	...
	parallel -j 8 -v \
		...
		--nice 19 --delay 2 \
		"run_azad.py wythoff_stumbler_strategist --save=$(DATA_PATH)/wythoff/exp25/run_{1} --monitor='('episode', 'influence', 'eval_score_a', 'eval_score_b', 'wins', 'win')' --stumbler_monitor='('episode', 'loss', 'score', 'total_reward')' --strategist_monitor='('episode', 'loss', 'mae')' --num_episodes=150 --update_every=10 --learning_rate_influence=0.2 --num_stumbles=500 --learning_rate_stumbler=0.4 --stumbler_game=Nim15x15 --epsilon=0.4 --anneal=True --gamma=0.5 --num_strategies=500 --learning_rate_strategist=0.025 --strategist_game=Nim50x50 --cold_threshold=-0.2 --hot_threshold=0.2 --hot_value=-1 --cold_value=1 --debug=False --save_model=True --return_none=True --debug=False --seed={1}" ::: \
		{1..20}
...
wythoff_exp26:
	...
	parallel -j 8 -v \
		...
		--nice 19 --delay 2 \
		"run_azad.py wythoff_stumbler_strategist --save=$(DATA_PATH)/wythoff/exp26/run_{1} --monitor='('episode', 'influence', 'eval_score_a', 'eval_score_b')' --stumbler_monitor='('episode', 'loss', 'score', 'total_wins', 'total_losses', 'total_reward')' --strategist_monitor='('episode', 'loss', 'mae')' --num_episodes=40 --update_every=10 --learning_rate_influence=0.2 --num_stumbles=500 --learning_rate_stumbler=0.4 --stumbler_game=Euclid15x15 --epsilon=0.4 --anneal=True --gamma=0.5 --num_strategies=500 --learning_rate_strategist=0.025 --strategist_game=Euclid50x50 --cold_threshold=-0.2 --hot_threshold=0.2 --hot_value=-1 --cold_value=1 --debug=False --save_model=True --return_none=True --debug=False --seed={1}" ::: \
		{1..200}
...
wythoff_exp28:
	...
	parallel -j 8 -v \
		...
		--nice 19 --delay 2 \
		"run_azad.py wythoff_stumbler_strategist --save=$(DATA_PATH)/wythoff/exp28/run_{1} --load_model=$(DATA_PATH)/wythoff/exp14/run_{1}.pytorch --new_rules=True --monitor='('episode', 'influence', 'eval_score_a', 'eval_score_b')' --stumbler_monitor='('episode', 'loss', 'score', 'total_wins', 'total_losses', 'total_reward')' --strategist_monitor='('episode', 'loss', 'mae')' --num_episodes=40 --update_every=10 --learning_rate_influence=0.2 --num_stumbles=500 --learning_rate_stumbler=0.4 --stumbler_game=Euclid15x15 --epsilon=0.4 --anneal=True --gamma=0.5 --num_strategies=500 --learning_rate_strategist=0.025 --strategist_game=Euclid50x50 --cold_threshold=-0.2 --hot_threshold=0.2 --hot_value=-1 --cold_value=1 --debug=False --save_model=True --return_none=True --debug=False --seed={1}" ::: \
		{1..200}

# Euclid w/ replay agent (pretrained w/ imagination)
wythoff_exp28_img-to-rep:
	-rm -rf $(DATA_PATH)/wythoff/exp28_img-to-rep
	-mkdir $(DATA_PATH)/wythoff/exp28_img-to-rep
	parallel -j 8 -v \
		--joblog '$(DATA_PATH)/wythoff/exp28_img-to-rep/exp28_img-to-rep.parallel.log' \
		--nice 19 --delay 2 \
		"run_azad.py wythoff_stumbler_strategist --save=$(DATA_PATH)/wythoff/exp28_img-to-rep/run_{1} --load_model=$(DATA_PATH)/wythoff/exp14/run_{1}.pytorch --new_rules=True --monitor='('episode', 'influence', 'eval_score_a', 'eval_score_b')' --stumbler_monitor='('episode', 'loss', 'score', 'total_wins', 'total_losses', 'total_reward')' --strategist_monitor='('episode', 'loss', 'mae')' --num_episodes=40 --update_every=10 --learning_rate_influence=0.2 --num_stumbles=500 --learning_rate_stumbler=0.4 --stumbler_game=Euclid15x15 --epsilon=0.4 --anneal=True --gamma=0.5 --num_strategies=500 --learning_rate_strategist=0.025 --strategist_game=Euclid50x50 --cold_threshold=-0.2 --hot_threshold=0.2 --hot_value=-1 --cold_value=1 --debug=False --save_model=True --return_none=True --debug=False --strategy='replay' --seed={1}" ::: \
		{1..200}

# Euclid w/ replay agent (pretrained w/ imagination)
wythoff_exp28_rep-to-rep:
	-rm -rf $(DATA_PATH)/wythoff/exp28_rep-to-rep
	-mkdir $(DATA_PATH)/wythoff/exp28_rep-to-rep
	parallel -j 8 -v \
		--joblog '$(DATA_PATH)/wythoff/exp28_rep-to-rep/exp28_rep-to-rep.parallel.log' \
		--nice 19 --delay 2 \
		"run_azad.py wythoff_stumbler_strategist --save=$(DATA_PATH)/wythoff/exp28_rep-to-rep/run_{1} --load_model=$(DATA_PATH)/wythoff/exp14/run_{1}.pytorch --new_rules=True --monitor='('episode', 'influence', 'eval_score_a', 'eval_score_b')' --stumbler_monitor='('episode', 'loss', 'score', 'total_wins', 'total_losses', 'total_reward')' --strategist_monitor='('episode', 'loss', 'mae')' --num_episodes=40 --update_every=10 --learning_rate_influence=0.2 --num_stumbles=500 --learning_rate_stumbler=0.4 --stumbler_game=Euclid15x15 --epsilon=0.4 --anneal=True --gamma=0.5 --num_strategies=500 --learning_rate_strategist=0.025 --strategist_game=Euclid50x50 --cold_threshold=-0.2 --hot_threshold=0.2 --hot_value=-1 --cold_value=1 --debug=False --save_model=True --return_none=True --debug=False --strategy='replay' --seed={1}" ::: \
		{1..200}
...
wythoff_exp1000:
	...
	parallel -j 8 -v \
		...
		--nice 19 --delay 2 \
		"run_azad.py wythoff_stumbler_strategist --save=$(DATA_PATH)/wythoff/exp1000/run_{1} --monitor='('episode', 'influence')' --stumbler_monitor='('episode', 'loss', 'score', 'total_wins', 'total_losses', 'total_reward')' --strategist_monitor='('episode', 'loss', 'mae', 'mae_euclid')' --num_episodes=2 --update_every=10 --learning_rate_influence=0.2 --num_stumbles=500 --learning_rate_stumbler=0.4 --stumbler_game=Wythoff15x15 --epsilon=0.4 --anneal=True --gamma=0.5 --num_strategies=500 --learning_rate_strategist=0.025 --strategist_game=Wythoff50x50 --cold_threshold=-0.2 --hot_threshold=0.2 --hot_value=-1 --cold_value=1 --debug=False --save_model=True --return_none=True --debug=False --seed={1}" ::: \
		{1..100}
...
wythoff_exp5000:
	...
	parallel -j 8 -v \
		...
		--nice 19 --delay 2 \
		"run_azad.py wythoff_stumbler_strategist --save=$(DATA_PATH)/wythoff/exp5000/run_{1} --monitor='('episode', 'influence')' --stumbler_monitor='('episode', 'loss', 'score', 'total_wins', 'total_losses', 'total_reward')' --strategist_monitor='('episode', 'loss', 'mae', 'mae_euclid')' --num_episodes=10 --update_every=10 --learning_rate_influence=0.2 --num_stumbles=500 --learning_rate_stumbler=0.4 --stumbler_game=Wythoff15x15 --epsilon=0.4 --anneal=True --gamma=0.5 --num_strategies=500 --learning_rate_strategist=0.025 --strategist_game=Wythoff50x50 --cold_threshold=-0.2 --hot_threshold=0.2 --hot_value=-1 --cold_value=1 --debug=False --save_model=True --return_none=True --debug=False --seed={1}" ::: \
		{1..100}
...
wythoff_exp10000:
	...
	parallel -j 8 -v \
		...
		--nice 19 --delay 2 \
		"run_azad.py wythoff_stumbler_strategist --save=$(DATA_PATH)/wythoff/exp10000/run_{1} --monitor='('episode', 'influence')' --stumbler_monitor='('episode', 'loss', 'score', 'total_wins', 'total_losses', 'total_reward')' --strategist_monitor='('episode', 'loss', 'mae', 'mae_euclid')' --num_episodes=20 --update_every=10 --learning_rate_influence=0.2 --num_stumbles=500 --learning_rate_stumbler=0.4 --stumbler_game=Wythoff15x15 --epsilon=0.4 --anneal=True --gamma=0.5 --num_strategies=500 --learning_rate_strategist=0.025 --strategist_game=Wythoff50x50 --cold_threshold=-0.2 --hot_threshold=0.2 --hot_value=-1 --cold_value=1 --debug=False --save_model=True --return_none=True --debug=False --seed={1}" ::: \
		{1..100}
...
wythoff_exp50000:
	...
	parallel -j 8 -v \
		...
		--nice 19 --delay 2 \
		"run_azad.py wythoff_stumbler_strategist --save=$(DATA_PATH)/wythoff/exp50000/run_{1} --monitor='('episode', 'influence')' --stumbler_monitor='('episode', 'loss', 'score', 'total_wins', 'total_losses', 'total_reward')' --strategist_monitor='('episode', 'loss', 'mae', 'mae_euclid')' --num_episodes=100 --update_every=10 --learning_rate_influence=0.2 --num_stumbles=500 --learning_rate_stumbler=0.4 --stumbler_game=Wythoff15x15 --epsilon=0.4 --anneal=True --gamma=0.5 --num_strategies=500 --learning_rate_strategist=0.025 --strategist_game=Wythoff50x50 --cold_threshold=-0.2 --hot_threshold=0.2 --hot_value=-1 --cold_value=1 --debug=False --save_model=True --return_none=True --debug=False --seed={1}" ::: \
		{1..100}
...
# Test transfer to Euclid after 50000 episodes of training on Wythoff's.
...
wythoff_exp14_replay:
	-rm -rf $(DATA_PATH)/wythoff/exp14_replay
	-mkdir $(DATA_PATH)/wythoff/exp14_replay
	parallel -j 8 -v \
